...
func IsHostReachable(client *http.Client, address string) bool {
	...
	// If we get here, 'err' was nil. The server successfully responded with an HTTP status code.
	// We don't care if the status is 200, 404, or 500; the host is "reachable".
	return true
}
...
func isIPv4(address string) bool {
	// maybe further filtering by a prefix? like 10.0.1.XXX
